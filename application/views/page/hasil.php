				...
				<div class="form-example-wrap mg-t-30">
					...
					<div class="form-example-int form-horizental mg-t-2">
						<div class="form-group">
							<div class="row">
								<?php foreach ($hsl as $data) { ?>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<?php
										$sama = $this->M_page->get_terbesar()->row();
										$sam = $this->M_page->get_sama($sama->tampung_ranking)->result();
										foreach ($sam as $ada) { ?>
											<h4><?= $ada->kode_product; ?></h4>
										<?php } ?>
										<br>
							...
							<div class="row">
								<a href="<?php echo base_url('rekomendasi') ?>" class="btn btn-primary notika-btn-primary">Kembali Mencari Rekomendasi </a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="data-table-list">
					...
					<div class="table-responsive">
						<table id="data-table-basic" class="table table-striped">
							...
							<tbody>
								<?php
								$data_pro = $this->M_page->get_all_product()->result();
								$no = 1;
