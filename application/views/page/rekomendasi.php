		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="form-example-wrap mg-t-30">
					<?php if (isset($usia_muda)) { ?>
						<div class="alert alert-danger">Usia anda kurang dari<strong> 23 tahun!</strong> tidak di rekomendasikan menggunakan skincare dewasa, coba rekomendasi remaja.</div>
					...
					<div class="cmp-tb-hd cmp-int-hd">
						<h2>Rekomendasi Skincare Dewasa</h2>
						<p>Pilih beberapa keterangan untuk dapat melakukan perhitungan rekomendasi skincare untuk dewasa</p>
						<p>Rekomendasi Skincare Dewasa ini hanya untuk <strong> usia 23 tahun keatas</strong> </p>
					</div>
					...
					<form action="<?= base_url() ?>hitung" method="POST">
						<div class="form-example-int form-horizental mg-t-2">
							<div class="form-group">
								...
								<div class="row">
									<?php
									$nm_krit = $this->M_page->get_nm_krit()->result();
										...
										<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
											...
											<div class="bootstrap-select fm-cmp-mg">
												<select class="selectpicker" name="id_keterangan[]">
													...
													<?php
													$nm_ket = $this->M_page->get_nm_ket($data->kode_kriteria)->result();
