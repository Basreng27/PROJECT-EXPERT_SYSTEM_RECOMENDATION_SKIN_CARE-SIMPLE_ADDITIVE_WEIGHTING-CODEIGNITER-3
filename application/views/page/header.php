            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li><a href=" <?= base_url() ?>home"><i class="notika-icon notika-house"></i> Home</a>
                        </li>
                        <li><a data-toggle="tab" href="#Rekomen"><i class="notika-icon notika-edit"></i> Rekomendasi</a>
                        </li>
                        <li><a href="<?= base_url() ?>login"><i class="notika-icon notika-support"></i> Login</a>
                        </li>
                    </ul>

                    <div class="tab-content custom-menu-content">
                        <div id="Rekomen" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="<?= base_url() ?>rekomendasi">Rekomendasi Product Dewasa</a>
                                </li>
                                <li><a href="<?= base_url() ?>rekomendasi_remaja">Rekomendasi Product Remaja</a>
                                </li>
                            </ul>
                        </div>
                    </div>
