            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-example-wrap mg-t-30">
                    <div class="cmp-tb-hd cmp-int-hd">
                        <h2>Edit Kriteria Remaja</h2>
                    </div>
                    <?php foreach ($data_kriteria_remaja as $data) { ?>
                        <form action="<?= base_url() ?>proses_edit_kriteria_remaja" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <input type="text" name="kode_kriteria_remaja" class="form-control input-sm" value="<?= $data->kode_kriteria_remaja ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
